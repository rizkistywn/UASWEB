...
<head>
  <meta charset="UTF-8" />
  <meta name="description" content="BakeRizki" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta http-equiv="X-UA-Compatible" content="ie=edge" />
  <title>BakeRizki</title>
...
<body>
  ...
  <div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
      <a href="#"><img src="{{ asset('frontend/img/bakerizkilogo.png') }}" alt="" /></a>
    </div>
    ...
    <div class="humberger__menu__contact">
      <ul>
        <li><i class="fa fa-envelope"></i> bakerizki@bakery.com</li>
      ...
      <div class="row align-items-center">
        <div class="col-lg-3">
          <div class="header__logo">
            <a href="/"><img src="{{ asset('frontend/img/bakerizkilogo.png') }}" alt="Logo" /></a>
          </div>
        </div>
        <div class="col-lg-6">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="footer__about">
            <div class="footer__about__logo">
              <a href="./index.html"><img src="{{ asset('frontend/img/bakerizkilogo.png') }}" alt="" /></a>
            </div>
            <ul>
              <li>Address: Jl. Kiaracondong</li>
              <li>Phone: (022) 875787</li>
              <li>Email: bakerizki@bakery.com</li>
            </ul>
          </div>
        </div>
